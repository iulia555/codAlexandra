package com.example.mobilebankingapp.classes.cards;
...
public class Transaction {
    ...
    public Transaction(int amount, String cardFrom, String cardTo, String currency, String date, String description, String status, boolean isUtilityBill) {
        Amount = amount;
        CardFrom = cardFrom;
        CardTo = cardTo;
        Currency = currency;
